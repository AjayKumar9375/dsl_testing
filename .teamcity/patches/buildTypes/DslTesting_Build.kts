...
To apply the patch, create a buildType with id = 'DslTesting_Build'
in the project with id = 'DslTesting', and delete the patch script.
*/
create(RelativeId("DslTesting"), BuildType({
    id("DslTesting_Build")
    name = "Build"
    ...
    vcs {
        root(RelativeId("DslTesting_HttpsGithubComAjayKumar9375dslTestingGitRefsHeadsMain"))
    }
